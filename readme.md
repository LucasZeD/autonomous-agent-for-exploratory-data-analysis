...
**Nota sobre LLMs Locais:** Para usar a opção `LocalLM`, certifique-se de que um serviço como o Ollama esteja em execução. O endpoint padrão configurado é `http://localhost:11434/v1`.
